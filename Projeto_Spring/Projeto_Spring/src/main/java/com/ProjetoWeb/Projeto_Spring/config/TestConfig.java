...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var o = new OrderEntities(null, Instant.parse("2024-05-20T20:00:00Z"),u);
        var o1 = new OrderEntities(null, Instant.parse("2024-05-20T20:10:00Z"),u1);
        var o3 = new OrderEntities(null, Instant.parse("2024-05-20T21:30:00Z"),u);
